...
function [optimum, gbest, fev, tElapsed] = MPSO(func_name,xmin,xmax,true_min,errgoal,cutoff_length,seed,c1,c2,rad,lbd,tmax)
    ...
    for i = 1 : N
        % Find minimum in the neighbourhood (particle indices lie on ring topology)
        % Alternate neighbourhood implementation: based on location of particles in search space
